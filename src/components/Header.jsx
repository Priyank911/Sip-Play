    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
            ...
            {navigation.map((item) => (
              <a
                ...
                className={`block relative font-code text-2xl uppercase transition-colors hover:text-color-1 ${
                  ...
                  item.url === pathname.hash ? "z-2 lg:text-black" : "lg:text-gray-500"
                } lg:leading-5 lg:hover:text-gray-700 xl:px-10`}
              >
                {item.title}
              </a>
            ))}
        ...
        <Button
          ...
          style={{ color: "black" }}
        >
          <MenuSvg openNavigation={openNavigation} style={{ color: "black" }} />
        </Button>
      </div>
    </div>
  );
